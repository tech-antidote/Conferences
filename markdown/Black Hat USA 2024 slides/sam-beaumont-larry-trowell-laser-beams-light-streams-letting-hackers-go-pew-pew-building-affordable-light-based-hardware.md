...
**Sam. Beaumont & Larry Trowell aka. PANTH13R & PATCH**
...
“It does not help, to throw gasoline on a fire….not unless you want a better fire” – Sam. Beaumont
...
### **Project “L.O.R.E.M” Samantha Isabelle Beaumont (Sam. Beaumont)**
...
# **Project “L.O.R.E.M” CHAS BECHT “The WISARD”**
...
**Project “L.O.R.E.M” KURTIS SHELTON “The** **~~actual~~ SCIENTIST”**
...
**Director, Director, Hardware & Transportation, Embedded Systems Mobility & CyberPhysical Systems**
...
**APPLICATION PENTESTING** Web & API Application Mobile Application Thick Application

**HARDWARE & INTEGRATED SYSTEMS** Hardware & Embedded Systems Cyber-Physical Systems

**NETWORK PENTESTING** Internal Network External Networks

**MAINFRAME PENTESTING**

**BLOCKCHAIN​ PENTESTING​**

**CLOUD PENTESTING** AWS Azure Google Cloud
...
**CYBERSECURITY MATURITY ASSESSMENT​** Security Program Advisory​ Incident Response​ Benchmarking

**AI/ML PENTESTING** Large Language Models

**RED TEAM**

**THREAT MODELING​**

“We are your allies in the battle for trust” – Team NetSPI
...
“Good judgment comes from experience…experience comes from bad judgment” – Chas Becht
...
“Why are we putting on the glasses of extreme headache?” – Larry Trowell
...
“By the end of this talk, you shall be….enlightened” – Larry Trowell
...
##### **<u>L</u>** ight **<u>A</u>** mplification by **<u>S</u>** timulated **<u>E</u>** mission of **<u>R</u>** adiation

- Bouncing photons inside a medium until they all march in lockstep

And security measures of every kind imaginable: Lasers, sharks, laser sharks...  -- Lego Movie
...
**“Semi-Invasive”** A visceral experience
...
“When you build a painful memory, that memory stays” – Chas Becht
...
“Leeeroooooy Jeeeenkins!” - Ben Schulz
...
“Mistakes were made” – Sam. Beaumont
...
### **Operation: Expense Report Cost Reduction** Objective: Domestication of Laser Tooling
...
➢To **position** the laser, target, or both

➢To fire, because 𝒕𝒉𝒆𝒚<sup>′</sup> 𝒓𝒆 𝒄𝒐𝒐𝒍<sup>𝑻𝑴</sup>

“We are glitching the f*ck out of this” – Team LOREM
...
“Well…that shouldn’t have worked…” – Team LOREM
...
You must have a calibrated eye
...
- Total Cost: **~$280 USD** • Approximate Savings: **~$6,720 USD**

“Let’s enable Microscopy for Everyone” - OpenFlexure
...
- Traditionally LFI stations work by firing a **highly powerful laser** for **a very short amount of time**
   ...
   - How much energy is _actually_ needed to cause a glitch?

- For example: a YAG laser can provide **tens of millijoules (mJ)** in **less than 10 nanoseconds (ns)**

   - Do we _really_ need that much energy in a short amount of time?
...
- That is an energy reduction of <u>𝟏𝒆</u><sup>−𝟔</sup>

Why did the nanojoule go to the therapist? Because it had a _small_ energy crisis.
...
**RayV-Lite** Everything Assembled
...
“V, because the last four blew themselves up” – Team L.O.R.E.M
...
“One must first connect the probe, before taking a measurement” – Team L.O.R.E.M
...
“You spend 3 months chewing glass…just to arrive at how to use hot glue, to solve the problem” – Chas Becht
...
# **Component Breakdown Positioning Stage**
...
# **Component Breakdown Beamsplitter**
...
# **Component Breakdown Laser Diode & Driver**
...
# **Component Breakdown Motor Controller**
...
# **Component Breakdown Laser Controller**
...
# **Component Breakdown IR LED (affixed to target)**
...
- Slows the target clock down to enable the lase to cover its time requirement
...
**But does it work?** FIRE ZE LASERS!!!
...
@PANTH13R @P4tch3dSYSt3m #BHUSA #BlackHatEvents 55
...
### **Infra-Red, In-Situ Inspection of Silicon** I.R.I.S.
...
“You can do IRIS with a simple halogen lamp and an IR-pass filter on your SLR” – Phillippe Teuwen
...
“How are we meant to see invisible light? ...With our invisible light camera” – Team LOREM
...
“What are those lines? …I don’t know, seems like some kind of circuitry!” – Team LOREM
...
@PANTH13R @P4tch3dSYSt3m #BHUSA #BlackHatEvents 62

## Slide 63

**But wait, there’s more!** Happy Accidents can happen
...
### **LASER LOGIC STATE IMAGING** L.L.S.I.
...
I tried to read my computer's mind, but it was all in binary. I think it's plotting against me, but I can’t decode its plans.
...
**Operation: Over Achiever** Because telling a hacker “no” is the fastest route to hyperproductivity
...
"Using AI to read people: because sometimes even robots need a good laugh at our emotional rollercoaster.“ - ChatGPT
...
“Science is cooler” – Sam. Beaumont
...
I tried to measure my IQ with a self mixing Interferometer, but it kept saying "error: object too dim".
...
- Pause instructions and memory in the transistors

- Send a signal through the active transistors (via modulation of voltage)

- Activate laser beam and scan beam over target

- Read the sent signal through the beam's reflection

How does a laser feel after a long day of logic state imaging? Exhausted, because it's been working its bits off.
...
**But does it work?** FIRE ZE LASERS!!! ….AGAIN!
...
@PANTH13R @P4tch3dSYSt3m #BHUSA #BlackHatEvents 75

## Slide 76

**“Artificial Intelligence”** The irony of making signals Human Readable by using a machine to read
...
**Machine Learning** Statistical Analysis using Convolutional Neural Networks
...
- Scanning a chip with Laser Scanning Microscope (LSM) is **<u>slow</u>**

- The process to design a low noise, band pass filter and demodulator to isolate signals around 1ppm is **<u>slow</u>**

- Combining an active LLSI and LSM to train a model, is **<u>really, really, slow</u>**
...
What do you call a machine learning engineer who can’t explain their job? Unsupervised.
...
I tried to have a deep conversation with my computer, but all I got was signal and noise. It was a real buzzkill
...
“Special Thanks to all the Wi-Fi endpoints you crashed as a result of having to serve this PowerPoint to SharePoint” – KMAP
...
Diff
Identified
Segment from  location of
LLSI Image #2 a 1 or 0
...
“HAVE YOU DEFINED ALL YOUR ACRONYMS?” – Casey Repp
...
**But does it work?** No lasers to fire this time 
...
“JOOOOOOOOOOOOOOOOOOOOOCE” – Kurtis Shelton
...
“Is it too early to retire?” – Sam. Beaumont
...
- We’ve coordinated our tools to opensource and release at **12:00 GMT-7, today (August 8**<sup>**th**</sup> **, 2024)**
...
Waldo and Wally were on a reality TV show called "Survivor: The Hidden." They lasted about five minutes before the host yelled, "We give up!"
...
“THIS WAS THE CHIP I WAS TOLD TO BUY IN MY DREAM” – Larry Trowell
...
**Money is no obstacle** Maker + Hacker mentality = profit

**Open Source is King** https://github.com/Project LOREM/RayVLite

“The worst thing that could ever happen to you, is that your talk actually gets accepted…because then you need to do your slides” – Phil Young

102

## Slide 103

**Thank you! Welcome to the real-life version of “Where's Wally”**

**…(or “Where’s Waldo”)**

**Catch us at our Booth! …or in HallwayCon …or at Hacker Summer Camp**

241 N 5th Ave Suite 1200 Minneapolis, MN 55401 **netspi.com**

**Larry.Trowell@netspi.com**

**Sam.Beaumont@netspi.com**

#BHUSA #BlackHatEvents 103

@PANTH13R @P4tch3dSYSt3m

## Slide 104

**That’s all Folks!** Thank you for listening, reading or watching us be nerds
...
**LASERS ARE COOL (but wear protection…..)**
