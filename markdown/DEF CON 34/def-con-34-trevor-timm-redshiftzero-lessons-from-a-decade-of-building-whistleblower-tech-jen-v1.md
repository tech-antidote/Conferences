...
Trevor Timm Executive Director Jennifer Helsby (@redshiftzero) Chief Technology Officer
...
a person asking for his public encryption, or PGP, key so he could send him
an e-mail securely. Greenwald didn’t have one, which he now
acknowledges was fairly inexcusable given that he wrote almost daily
about national-security issues, and had likely been on the government’s
radar for some time over his vocal support of Bradley Manning and
WikiLeaks. “I didn’t really know what PGP was,” he admits. “I had no idea
how to install it or how to use it.” It seemed time-consuming and
...
step tutorial on encryption. Then he sent him a video Greenwald describes
as “Encryption for Journalists,” which “walked me through the process like
I was acomplete idiot.”
And yet, Greenwald still didn’t bother learning security protocols. “The
more he sent me, the more difficult it seemed,” he says. “I mean, now I had
to watch a fucking video...?” Greenwald still had no idea who the source
...
USnational security NSA collecting phone records of
millions of Verizon customers daily
Exclusive: Top secret court order requiring Verizon to hand
over all call data shows scale of domestic surveillance under
Obama
...
```text
SURVEILLANCE F
COPY LINK TO SHARE 'U
Justice Department Investigation of AP
Part of Larger Pattern to Intimidate
Sources and Reporters
May 13, 2013 / TREVOR TIMM
As part of a new leak investigation, the Justice Department has secretly
obtained the call records for twenty phone lines owned by the Assocated
Press (AP), which could put sources for as many as one hundred reporters at
...
```text
NiemanReports
Home Articles About Winter 2025 Magazine
WATCHDOG
James Risen’s First Amendment Battle
For six years, New York Times national security reporter James Risen has been
fighting to keep his promise of anonymity to a source who told him about a failed CIA
initiative. The latest round started last month when Risen asked the U.S. Supreme
Court to recognize his First Amendment right to protect his source. If the justices
...
Institute that brought together lawyers, journalists and intelligence
officials to talk about government secrecy. The ground rules, she
said, were that the identities of those involved were to be kept
confidential, but what was said could be reported.
“TI was told in a rather cocky manner” by a national security
...
Politics DonaldTrump TheFix TheBriefs Polling © DemocracyinAmerica Elections
...
And yet. There must be a secure, anonymous way to get them to
@Fahrenthold. x.com/chrisdocnee/st...
==FREEDOM OF THE PRESS FOUNDATION https://freedom.press
```
...
US
The,. —
News Opinion Sport Culture Lifestyle @ Guardian
USnews US politics World Cup 2026 World Climate crisis Middle East Ukraine USimmigration Business Environment Tech Science Newsletters The Filter
PeteHegseth ~~ _Hegseth announces joint taskforce with
DoJ to target and prosecute press leaks
Paranoid Kash Patel Orders Polygraphs for FB)
US defense secretary says taskforce will ‘combat dangers’ of
...
FBI raids home of Washington Post Pentagon bars journalists from its
reporter in ‘highly unusual and press office, saying it has become a
aggressive’ move t Ord ’ ’
classified space
...
How do we eliminate tech companies from our conversations?

**Solution:** Run SecureDrop server on-premises

Challenge:

● Makes assisting news organizations hard

● No observability in running systems
...
SFCUREDROP You will need this codename to log into our SecureDrop later:
($) crawfish retold roman cold splice caviar zap
¢ Keep it secret. Do not share it with anyone. Show Codename
...
**Lesson 1: Eliminate third parties** ➡ _On-premises servers_ **Lesson 2: Plan for malware** _Airgap_

**Lesson 3: Embrace anonymity** _Tor onion services_ **Lesson 4: Sources and journalists need to talk** _Enable long-lived conversations_
...
Anti-spam mitigations: make it easier to sort through spam on the backend

https://freedom.press

## Slide 37

### **Lesson 6: End-to-end encryption is hard in the browser environment**
...
Operation
BY MARK RUMOLD | SEPTEMBER 15, 2016
FBI Admits It Controlled Tor Servers Behind Mass Malware X f
Attack
It wasn't ever seriously in doubt, but the FBI yesterday acknowledged that it secretly took
control of Freedom Hosting last July, days before the servers of the largest provider of
...
```text
Watering Hole Attacks
While the FBI was running Playpen, it began sending malware to visitors of the site,
W I I exploiting (we believe) a vulnerability in Firefox bundled in the Tor browser. The
government, in an effort to downplay the intrusiveness of its technique, ng
euphemistically calls the malware it used a “NIT” —short for “Network Investigative
FBI Admi Technique.” The NIT copied certain identifying information from a user’s computer
...
**Lesson 1: Eliminate third parties** ➡ _On-premises servers_

**Lesson 2: Plan for malware** _Airgap_

**Lesson 3: Embrace anonymity** _Tor onion services_

**Lesson 4: Sources and journalists need to talk** _Enable long-lived conversations_ **Lesson 5: Spam is a constant battle for anonymous systems** _Make it easy to filter out_

**Lesson 6: End-to-end encryption is hard in the browser environment** _Harden the servers_
...
```text
Re-designing SecureDrop from the ground up
Overview List of SecureDrops News Contribute Donate Docs Research Q
SECUREDROP
Share and accept documents securely.
SecureDrop is an open source whistleblower submission
system that media organizations and NGOs can install to
...
Only /home, /usr/local , /rw/config will
persist through a reboot, otherwise state is reset
to the base TemplateVM
AppVM
Dom0
(fedora)
...
- No state or persistent accounts on the source client side

- ● Minimize metadata available to the server
...
A
” ) 4 This add-on is not actively monitored for security by Mozilla. Make sure you trus'
WEBCAT
by Freedom of the Press
Foundation
J WEBCAT verifies the integrity and transparency properties of
...
```text
Build code integrity directly into browsers
WEBCAT Integrity Error
WEBCAT was unable to verify the integrity of this website.
...
**Questions for anyone building whistleblower tech** 1. How do you eliminate third parties, including yourself? 2. What’s your plan for malware for sources and journalists?

3. Can you provide anonymity?

4. How can sources and journalists talk?

5. How can you provide E2E encryption without an app? 6. How can you do all of this and mitigate spam?
...
Everything we do is free and open source: ● <u>https://github.com/freedomofpress/securedrop</u> ● <u>https://github.com/freedomofpress/securedrop-workstation</u> ● <u>https://github.com/freedomofpress/securedrop-client</u> ● <u>https://github.com/freedomofpress/securedrop-protocol</u> ● <u>https://github.com/freedomofpress/webcat</u>
...
Copies of stolen FBI ree: majipox. ‘ were received "Monday by
ords sent to The Washington) “1p addition,” continues the Sen. George McGovern (D-
Post described the bureau's Sept, 16, 1970, document, 5:2) and Rep. Parren J,
surveillance of campus andisome will be overcome by Mitchell (D-Md.). MeGovern
black activist organizations atithe overwhelming _personali- and Rep. Mitchell “gave
4 i i ‘ FBI the documents,
...
used by news organizations worldwide, including
the Washington Post, Der Spiegel, The New York
Times, The Guardian, ProPublica, and others. It is
designed to help whistleblowers reach out and
share information safely and anonymously.
...
**Thank you!** <u>jen@freedom.press trevor@freedom.press securedrop.org</u>
...
How to submit a tip
to a news
outlet anonymously Thank you!
SecureDrop is a whistleblower submission system
used by news organizations worldwide, including jen@freedom.press
the Washington Post, Der Spiegel, The New York trevo r@freedom press
Times, The Guardian, ProPublica, and others. It is
designed to help whistleblowers reach out and
share information safely and anonymously. secu red rop.org
As a whistleblower, you should protect yourself as much as you can.
SecureDrop is intended to help you do that while you perform an essential role
in civil society. Thank you, and stay safe.
FREEDOM OF THE PRESS FOUNDATION https://freedom.press
