...
LAB_0013ed90 X ] 00 A
0013ed90 ldr -
oo 3a99 ve sit, openSUSE
0013ed98 4 ldp
0013ed9c dp
0013eda0 dp
ool3edas br - black hat
O82.
```
...
cc_Is_Gcc
FUNCTION _GRAPH_TRACER || DYNAMIC_FTRACE_WITH_ARGS)
black hat
2026
```
...
```text
Bionic (/ Ilvm-libunwind)
inet le Linn a CFI Safe Pivo
001f4190 df bti
001F4194 02 dp
001f4198 04 dp
001F419c 06 dp
...
@043b026 = movk w2, #0x1, 1lsl #@x1@ {@x1@@0b}
...
@043affc madd Spd Wa yee)
@043b008 str wi, [x@]
@043b004 Isr x1, x1, #0x20
@043b0e8 «strh wi, [x@, #0x4] gadget
@043b00c mov wo, #0
@043b018 ret
Black hat
```
