---
title: "Render Safe Live EOD PackBot Demonstration"
speakers: ["Patrick Kiley", "Emily Astranova"]
conference: "Black Hat"
conference_full: "Black Hat USA 2026"
edition: "USA"
year: 2026
source_pdf: "BlackHat_USA_2026_Slides/Patrick Kiley&Emily Astranova_Render Safe Live EOD PackBot Demonstration_Compressed.pdf"
pages: 57
sha256: "e795f12769804afdc122425066b33ba57685e277e62e5721492b6872a446106e"
text_chars: 17789
ocr_pages: 9
has_ocr: true
redacted_secrets: 0
...
converted_at: "2026-08-11T23:14:46Z"
---
# Render Safe Live EOD PackBot Demonstration
...
## **Agenda 01 Surplus Store to Bench**

## **02 Hardware Architecture & Teardown**

## **03 OCU Evolution 04 Software, Vulnerabilities and Exploitation 05 Communications, RF and Control 06 Lessons, Future Work and Credits**
...
USB, Ethernet, RS422, Differential FPGA signals, analog video A few unidentified signal pins
...
# **Vulnerabilities and Software, Exploitation**
...
- ● /opt/irobot/bin/aware-cfgdb ← Listens on high random port ○ Uses libshttpd.so
...
```text
Web Server Pa CG @ “A\Notsecure 172.16.46.176
e Port 80
PackBot Chassis Login
Username: | |
Password: |
| Submit |
:~$ nmap -Pn -sV -T4 172.1 176
Starting Nmap 7.94SVN ( https://nmap.org ) at 2026-06-30 16:10 PDT
Nmap scan report for 172.16 176
...
```text
Video Feed Demo
BB Windows Pow X BE Windows Pow X BE Windows Pom X + a x | ¥ @ t270.0:-8080 $ Ask Gemini
PS C:\Users\Emily\Documents\Packbot\6x_testing> python .\boomba_decoder. 23 @ © 127008080 4 QB Relaunch toupdote ¢
py 11976 8080 Wi-Fi
Battery: ?
407 PM
...
```text
Bot Hijack
File Edit Vi mes Help HW & O28 DOOR Ee
B ocusiz
X BB Windows Powershell
‘uments\Packbot> curl
Select Robot...
Maintenance...
Shut Down
Cl Navigate
(2) Select
FRROBOE AWARE 2 :0vc: intetigence software
Mandiant Google Cloud 42
```
...
```text
Packbot 510
e Used through at least 2015
e OpenVPN - Not encrypted
e 4.9 Ghz radio - Not encrypted
dev tape
cipher none
Fast-10
ping 1
...
5555 Ubiquiti_44:7f:44 5000 802.11 76 Acknowledgement, Flags=
172.16.0.5 IPv4 1514 Fragmented IP protocol (proto=UDP
1194 10.0.0.54 1194 OpenVPN 88 MessageType: Unknown Messagetype
5555 Ubiqui 500 802.11 76 Acknowledgement, Flags= =.
Ubiquiti_44:7.. 5555 Broadcast 5@00 802.11 178 Beacon frame, SN=405, FI Flags:
10.0.0.4 1194 10.0.0.54 1194 OpenVPN 1431 MessageType: Unknown Messagetype
172.16. 5555 Ubiquiti_/ 5000 802.11 76 Acknowledgement, Flags= ic
172.16. 172.16.0.5 IPv4 1514 Fragmented IP protocol (proto=UDP
10.0.0. 1194 10.0.0.54 1194 OpenVPN 88 MessageType: Unknown Messagetype | >o —
172.16.0. 5555 Ubiquiti_44:7F:44 500 802.11 76 Acknowledgement, Flags= c
172.16. 172.16.0.5 IPv4 1514 Fragmented IP protocol (proto=UDP 2d ++ YOB. ..
10.0.0.4 1194 10.0.0.54 1194 OpenVPN 88 MessageType: Unknown Messagetype | 00 ackbot1
172.16. 5555 Ubiquiti_44: 5000 802.11 76 Acknowledgement, Flags= c | ee
172.16. 172.16.0.5 Pv4 1514 Fragmented IP protocol (proto=UDP ee
10.0.0. 1194 10.0.0.54 1194 OpenVPN 88 MessageType: Unknown Messagetype
172.16.0.: 5555 Ubiquiti_44:7f:44 5000 802.11 76 Acknowledgement, Flags= on
10.0.0. 1194 10.0.0.54 1194 OpenvPN 816 MessageType: Unknown Messagetype | 40
172.16.8.: 5555 Ubiquiti_44:7f: 5000 802.11 76 Acknowledgement, Flags= .c |15
10.0.0. 1194 10.0.0.54 1194 OpenVPN 598 MessageType: Unknown Messagetype | 9@
172.16.0. 5555 Ubiquiti_44:7F:44 500 802.11 76 Acknowledgement, Flags= e ||
10.0.0. 1194 10.0.0.4 1194 OpenVPN 226 MessageType: Unknown Messagetype|!
172.16.0. 5555 Ubiquiti_44:5a:2f  5ee0 802.11 76 Acknowledgement, Flags= wc | 96
10.0.0.4 1194 10.0.0.54 1194 OpenVPN 227 MessageType: Unknown Messagetype[N 0@
172.16.' 5555 Ubiquiti_44: 5e00 802.12 76 Acknowledgement, Flag: c}1e
10.0.0. 1194 10.8 1194 OpenVPN 228 MessageType: Unknown Messagetype[ 29
172.16.0.40 5555 5000 802.11 76 Acknowledgement, Flags= on 2d .. Y6B. ....e0d-
...
Future Work
& Credits
Askus for STICKERS! DO) KOT Yor eS a:
IN JAVELIN =
Mandiant Google Cloud 551
```
