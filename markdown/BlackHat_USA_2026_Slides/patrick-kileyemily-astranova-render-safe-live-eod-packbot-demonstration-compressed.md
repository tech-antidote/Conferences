...
vision_verified_pages_changed: 55
...
- **1998** — DARPA and iRobot Research started
- **2001** — PackBot used at WTC
- **2007** — PackBot 510 Released
- **2016** — Endeavor Robotics Created
- **2019** — FLIR acquires Endeavor
- **2021** — Teledyne Acquires FLIR
- **2022** — PackBot 525 Released
...
Photo callouts: USB Hubs, Bus Transceivers, FPGA, Video Converter, Flipper Position Encoder, Parking Brake, Flipper Motor
...
Schematic pin labels (top): 40 TX4+, 39 TX4-, 38 CMGND, 37 RX4+, 36 RX4-

Schematic pin labels (bottom): TD4+ 1, TD4- 2, CT4 3, RD4+ 4, RD4- 5
