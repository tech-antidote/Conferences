...
* thread #1,
stop reason =
* frame #0: Oxfffffee01fbb63be kernel.release.t6000° DebuggerTrapWithState(db_op=DBOP_PANIC, db_message="panic", db_panic_str="%s %s%s%s\n%s", db_panic_args=Oxfffffe84@d8c7df8, db_panic_options=0, db_pan
ic_data_ptr=0x0000000000000000, db_proceed_on_sync_failure=1, db_panic_caller=18446741875263258400) at debug.c:714:2 [opt]
frame #1: Oxfffffee01fbb593c kernel.release.t6000° panic_trap_to_debugger(panic_format_str="%s %s%s%s\n%s",
data_ptr=0x0000000000000000, panic_caller=18446741875263258400) at debug.c:1175:2 [opt]
kernel. release. t6000° panic_with_options(reason=<unavailable>,
RTBuddy “RTBuddyCrashlogEndpoint: :_handleCrashlog(bool) + 1280
IOSlaveProcessor IOSlaveEndpoint::checkForWork() + 124
#2:
#3:
#4:
#5:
...
Oxf ffffee020333fd4
Oxf ffffeee2263bf2e
Oxf ft fFfeee2209e5ee
Oxf ffffe0020242e54
Oxf ff fFfe00202439dc
Oxf ffffeee1fb70e98
panic_args=0xfffffe840d8c7df8, reason=0, ctx=0x0000000000000000, panic_options_mask=0, panic_
ctx=<unavailable>, debugger_options_mask=<unavailable>, str=<unavailable>) at debug.c:1018:2 [opt]
kernel. release.t6000* IOWorkLoop: : runEventSources(this=0xfffffe33ceba17b@) at IOWorkLoop.cpp:403:18 [opt]
kernel.release.t6000° IOWorkLoop: : threadMain(this=0xfffffe33ceba17b@) at IOWorkLoop.cpp:434:8 [opt]
kernel.release.t6000°Call_continuation + 216
read Oxfffffe33cedf8000
41
69
64
72
...
@001b4b04 8xe000
@000001ad658 OxO
Case #/ - Video streaming attack surface
```
...
checkForWork() + 124
Oxfffffe29a6728000: 44 41 54 41 20 41 42 Gf 52 54 20 20 70 63 3d 30 DATA ABORT pc=0 C #8 CVE 20275 74. | | |
Oxfffffe29a6728010: 78 30 30 30 30 30 30 30 30 30 30 33 62 61 38 35 x20000000003ba85 dase - - =
Oxfffffe29a6728020: 34 20 45 78 63 65 70 74 69 6f 6e 20 63 6c 61 73 4 Exception clas
Oxfffffe29a6728030: 73 3d 30 78 32 35 20 28 44 61 74 61 20 41 62 6f s=0x25 (Data Abo
Oxfffffe29a6728040: 72 74 20 74 61 6b 65 be 20 77 69 74 68 6f 75 74 xt taken without
Oxfffffe29a6728050: 20 61 20 63 68 61 6e 67 65 20 69 6e 20 45 78 63 a change in Exc
Oxf FFF fe29a6728060: 65 70 74 69 6F be 20 6c 65 76 65 6c 29 2c 20 49 eption level), I
Oxfffffe29a6728070: 4c 3d 31 2c 20 69 73 73 3d 30 78 37 20 66 61 72 L=1, iss=0x7 far
Oxfffffe29a6728080: 3d 30 78 66 66 66 66 66 66 66 66 34 30 65 38 32 =OxfffFTTff40es2
Oxfffffe29a6728090: 63 39 38 20 2d 20 64 63 70 61 76 2d 76 69 64 65 C98 - dcpav-vide
Oxfffffe29a67280a0: 6f 2d 69 6e 74 65 72 66 61 63 65 2d 65 70 69 63 o-interface-epic
Oxf FFF fe29a67280bO: 28 38 39 29 OB 0 OO AO GO 2A QO OO OO 22 20 OO (89).........4--
Oxf ffffe29a67280cO: O86 G0 BO BB BO O28 OB BB BB BB BB BO BO BO BO 00
Oxf ffffe29a67280de: O80 G0 8G BG BB G8 OB BA BB 2B BO BO BO BO BO 00
Oxf ffffe29a67280e0: 00 G0 88 BB BO G8 BB BB BB BB BB BO BO BO BO 00
Oxf ffffe29a67280FO: 0 GO BO BO BB OB BB BA BB BB BB BO BO BO BO 00
Oxfffffe29a6728100: 52 54 4b 69 74 3a 20 52 54 4b 69 74 2d 32 37 35 RTKit: RTKit-275
