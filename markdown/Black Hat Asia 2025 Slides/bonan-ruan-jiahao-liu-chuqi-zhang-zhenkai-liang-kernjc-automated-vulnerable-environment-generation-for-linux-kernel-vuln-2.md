...
converted_at: "2026-08-11T21:03:50Z"
---
...
```text
#) ,
blackhat DOCKER-LIKE(NTERACTION!
$ ./kjc build CVE-2016-10150 O
; [x] Removing potentia 0
$ ./kjc -h [+] Auto-selected kerr $ -/kjc start --enable-kvm a3 cb
usage: kjc [ [x] Initializ- [x] Starting env a3
./kKj [+] Started env a30ebfa6
KernJC - AL Le] toon ea o/ us — — — —| $ ./kjc exec a3 /home/user/poc o
[*] D | | ID Warning: Permanently added '[localhost]:10000' (ECDSA) to the list of known hosts.
g
optional arg oe ereal _ $ cd db/pocs/cve-2016-101587, gcc -0 poc poc.c —Static, ca — G
-h, --help . ~/pjts/KernJC
, [x] Applying | a30ebq
“Vv, —-vers] 14) Loading ¢ +-—-—— $ ./kjc cp db/pocs/cve-2016-10150/poc a3:/home/user/
x] Coneratil $ ./kjc Warning: Permanently add O
subcommands:| |.) Finding | {'creat poc $ ./kjc logs 7 a3 G
{update, bu [4] Building ‘eve': #CVE-2016-10150" ++» Output omitted ...
update le] Built ke{ ‘ipt: N [ 408.497181] ================== a
build unit KC eon! $ ./kjc logs -f a3 [ 408.498170] BUG: KASAN: use-after-free in kvm_vm_ioctl+0x1150/0x1340 at addr ffff8800
start | [t! Found 37) iat, | £ OK 1 Reached target | [ 408.498170] Read of size 8 by task poc/2983
stop [x] Loading { oe Starting Update} [ 498.498170] CPU: 1 PID: 2983 Comm: poc Tainted: GB 4.8.12 #1
- _
attach [1] SU teat eer [ OK ] Finished Update] [ 4@8.498170] Hardware name: QEMU Standard PC (i440FX + PIIX, 1996), BIOS 1.10.2-1ubunt
exec [x] Merging i [ 408.498170] @000000000000097 ffffssee6lisfafo ffffffffsibfeSa2 fff f88006cc018C0
cp [+] Applied custom cor Debian GNU/Linux 11 kern} [ 408.498170] ffff88006b8c9a20 TfTF8B00Gb8c9a6O FTTTFTT83a46400 Ft ft88006118Tb18
logs -+» kernel compilation ... output omitted ... | [ 408.498170] ffffffff815c8cbc Ffff88006118fba8 Ffff88006b8c9a20 FfFF88006cc018C0
re os a Tt a code [ 408.498170] Call Trace:
val) Firayobelis) Wietoieue . . output omitted ...
ia [+] Env a30ebfa6f57474q $ -/kjc attach a3 p
SoMOL - ++» Output omitted ...
info show info o user@kernjc:~$ su # password: neo
query query a vul Password:
root@kernjc:/home/user# . Oo
Adding user ‘user' to gr $ ./kjc rm —-force a3 G
Adding user user to grou [+] Env a30ebfa6f5747fa9 removed
Done.
```
