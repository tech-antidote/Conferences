---
title: "Foreign Information Manipulation and Interference (Disinformation 2.0) - How Patterns of Behavior in the Information Domain Threaten or Attack Organizations' Values, Procedures and Poli"
...
converted_at: "2026-08-12T01:43:22Z"
---
...
###### **@frankylitics.bsky.social**

### Franky Saegerman

Head of Social Media (2012-2016) Head Digital Insights (2016-2020) Information Environment Analyst (2020-2024) #BHAS @BlackHatEvents
...
• Mostly non-illegal activities. • Deliberate patterns of behaviour • Content threathens or potentially impacts procedures and political processes. • Manipulative, intentional and coordinated.

values,

Not all Disinformation is FIMI. FIMI is not only Disinformation.
...
operated by a government and its
representatives, openly reflecting the
state's official voice
= Examples: Government accounts,
MFA representatives
OVERT t
Channels that operate under state
oversight without publicly disclosing
their affiliation. Uncovering their
connection to the state requires a
combination of evidence to reveal hidden
patterns of influence or indirect control.
* Examples: Channels run by intelligence
services, controlled by individuals with
strong ties to the government or ruling
...
CHANNELS
False Portal Kombat
Facade (News-Pravda.com)
RU
Foreign Intelligence Russian Russian
Embassies Missions
Channel One Russia
RUPTLY
Ruptly TV Sputnik
...
= |dentify and map the most influential actors, coalitions
and their networks as well as their intent and motives.
rN Threat Intelligence
The Blackbird.Al Risk Index scores threats related to
toxicity, polarization, automated networked activity,
sexism, hate speech, and manipulation.
Impact Intelligence
...
for News
Share of U.S. adults who regularly get news from TikTok, Share of respondents who find it difficult to identify
...
##### • Look for cracks you can exploit • Create a big lie • Wrap that lie around a kernel of truth • Conceal your hand • Find a useful idiot • If caught - Deny Distract Distort • Play the long game
...
**The Boston Times Miami Chronicle 1,265 websites in US alone – surpassing the number of genuine local newspapers (1,213)**

**New York News Daily**

**DC Weekly** #BHAS @BlackHatEvents

## Slide 22

# **Paperwall & Glassbridge** Paperwall & Glassbridge
...
#BHAS @BlackHatEvents **123 Websites over 30 countries masquerading as local news outlets**
...
@ Compass Context
The claim that the Eiffel Tower caught fire has been debunked by multiple
credible sources. According to a | ¢ k, the Eiffel Tower in Paris,
France, was not set ablaze in mid-January,
pite a fake image circulating
online. Similarly. reported that the purported incident was not
of the Eiffel Tower
covered by any credible news organizations, and phc
taken on January 24, 2024, show no signs of fire. also confirmed
that the Eiffel Tower did not catch fire in January 2024, and the viral video of
flames spewing out of the Eiffel Tower was most likely created using CGI
Furthermore. f reported that images of the Eiffel Tower on fire were
determined to be 97.42% machine-generated using Al detectors, revealing
isistencies common in images generated by artificial intelligence. These
sources collectively confirm that the claim of the Eiffel Tower catching fire i
...
Fake: Children are welcoming Ukrainian
Army
S @BlackHatEvents
```
...
**Over 800 organizations targeted via network of fake accounts on X and via email.**
...
### **Affecting AI models** **<u>Pravda Network</u>**

• Infiltrating retrieved data of AI Chatbots • Publishing false claims affecting response of AI News models

• Distorting how LLMs process news and info • Content now incorporated in Western AI systems infecting responses.
...
**150** Domains aggregating content from Russian sources

**3.6 Million** Articles published per year.

**207** Disinformation Narratives between 2022 and 2025

**4** Social media platforms leveraged to reinforce narratives via coordinated cross platform repetition

**49** Countries and regions targeted

**46+** Languages that the network published content in
...
wearing the insignia of the SS Reich division.
Later, this frame from the video was removed, and the
video was re-uploaded to the alliance’s resources in an
updated version.
...
Abzeichen der 2. SS-Panzerdivision Das
5	1	30	1	3	6	2797	906	85	20	86.473511	Reich..
anzeigen
```
...
Downtown Fairy
? @Downtownfairy
No. Zelensky has enough mansions and yachts. It’s time to take care of
America.
Dane
@UltraDane
Ukrainian President Zelensky and his close associate purchase 2 luxury
yachts “Lucky Me” and “My Legacy,” with a staggering combined value of
$75 million.
...
**Dec 2023 - Senate Republicans have blocked a move to pass an aid bill for Ukraine**
...
Goebbles' villain
Berlin
DISINFORMATION, AS IF ZELENSKYY BOUGHT GOEBBELS’
FORMER VILLA
SPAIN
Zelensky bought King
...
Narrative Deep-Dive Network Analysis: Bot Activity

### **Case Studies**

- ⬡ This network graph is taken from a narrative alleging that South Korea is part of a network of US vassal states that are now paying the price for pledging fealty.

- ⬡ Influencers in this narrative received significant inauthentic amplification from bot-like users, as shown in the adjacent network graph.
...
Narrative Deep-Dive Network Analysis: Cohort Activity

- ⬡ Cohort activity in this narrative was split evenly among Russian and Chinese State Supporters - each at 17% of total users.

- ⬡ Central consumers and amplifiers of influencerdriven content tended to be composed mostly of Chinese State Supporters, indicating that this could be both the target audience and main sources of amplification. **COHORT LEGEND**

- **Russian State Supporter Chinese State Supporter Other User**
...
_“The world must remember WWII era atrocities committed by Japan”_
...
- ⬡ Bot-like activity was high at 25.8% and distributed throughout the network for this narrative.

- ⬡ Looking at activity over time on the graph did not reveal any significant patterns related to bot-like activity.

**COHORT LEGEND Bot-Like User Other User**
...
- ⬡ Chinese State Supporters were the dominant cohort for this narrative, at over 26% of post volume.

- ⬡ The largest influential node on the graph falls within the pro-China cohort; additionally, much of the networked activity around them came from other Chinese State Supporters.

**COHORT LEGEND Chinese State Supporter Other User**
...
• AI generated content/spam • AI Social Media Bio generators • AI generated fake comments • AI generated audio/images/videos
...
Anyone can generate deepfakes. They have become easier and cheaper to make and simpler to disseminate on social media and messaging platforms.
...
• Sabotage • Disruption of critical infrastructure • Cyberattacks • Information manipulation and interference • Attempts to undermine democracy and the electoral process
...
and Germany SSS __i—e.. und fordern mehr Klimaschutz von Minister
Rheinmetall is Germany’s largest manufacturer of 155mm artillery shells, a Habeck
crucial resource for Ukrainians defending themselves against Russia’s war.
> LISTEN ( SHARE
In Langenau wurde der Auspuff eines Mini mit Bauschaum
verstopft
```
